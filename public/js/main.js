...
require(["/socket.io/socket.io.js", "jquery", "bootstrap.min"], function(io) {
  ...
  require(["plugins"], function() {
    ...
    function iPost() {
      ...
      console.log("post request called ["+modalName+"]");
      //$('#' + modalName).modal('hide');
      //$("#myModal").modal('hide');
      //$('#' + modalName).hide();

    }
    $('.iPost').unbind('click', iPost);
    $('.iPost').bind('click', iPost);
